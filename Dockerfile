...
RUN DEBIAN_FRONTEND=noninteractive apt-get install -y libmojo-server-fastcgi-perl

RUN mkdir -p /var/www && cd /var/www && git clone https://github.com/korjavin/mojo.git && cd mojo && git checkout tags/sip_cloud
